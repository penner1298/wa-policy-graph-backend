...
db_path = 'sao_2024.db' # Keeping them in the same master DB for now
...
def fetch_list():
    ...
    # Grab everything from Jan 1 2025 to current (May 2026)
    payload = "pageSize=500&pageNumber=1&HasFindings=true&LocalGovernment=true&StateGovernment=false&PerformanceAudits=false&SpecialInvestigations=false&UseOfDeadlyForceInvestigation=false&PoliceCertificationAudit=false&StartDate=01/01/2025&EndDate=12/31/2026"
...
async def main():
    print("Initiating 2025-2026 SAO Sweeper Full Run...")
    reports = fetch_list()
    total = len(reports)
    print(f"Total reports to process: {total}")
    
    os.makedirs("reports_2025_2026", exist_ok=True)
    ...
    async with httpx.AsyncClient() as client:
        for i, r in enumerate(reports):
            ...
            pdf_path = f"reports_2025_2026/{rnum}.pdf"
    ...
    print("\n=========================================")
    print("2025-2026 SWEEPER FULL RUN COMPLETE")
